...
export class LayoutComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('ktHeaderMobile', { static: false }) ktHeaderMobile: ElementRef;
  ...
  ngOnInit(): void {
    (document.querySelector('.Loader') as HTMLElement).style.display = this.loading;
  ...
  ngAfterViewInit(): void {
    if(localStorage.getItem("AlertType")!=null && localStorage.getItem("AlertType")!=''){
